...
class RoomScreenViewModel: RoomScreenViewModelType, RoomScreenViewModelProtocol {
    ...
    private func startCall(isAudioOnly: Bool) {
        // The call type is communicated to the call screen via AppSettings, so from the
        // RoomScreen perspective we just request that the call UI be shown.
