...
# 3. Merge and auto-resolve configuration conflicts
# 4. Regenerate Xcode project
# 5. Validate ketal configuration

# For detailed guide, see UPSTREAM_SYNC_GUIDE.md
```

**Manual Method** (for advanced users or troubleshooting):
```bash
# 1. Fetch upstream
git fetch upstream
...
- **Upstream Sync**: [UPSTREAM_SYNC_GUIDE.md](UPSTREAM_SYNC_GUIDE.md) - Comprehensive guide for syncing with upstream
- **Sync Script**: [sync-upstream.sh](sync-upstream.sh) - Automated upstream merge script
